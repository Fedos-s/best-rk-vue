<template>
  <div>
    <img class="element__img" :src="`img/kot${ImgId}.webp`" alt="Фотография" />
    <div class="element__bottom">
      <h3 class="element__title">Заголовок карточки</h3>
      <address class="element__address">Адрес</address>
      <span class="element__like-icon">
        <svg
          version="1.1"
          id="Capa_1"
